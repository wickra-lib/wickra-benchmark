...
**Part of the [Wickra ecosystem](https://github.com/wickra-lib) — for Python. `pip install wickra-benchmark` — prebuilt wheels for Linux, macOS and Windows, nothing to compile.**
...
- **Runnable example:** [`examples/python/`](https://github.com/wickra-lib/wickra-benchmark/tree/main/examples/python)
