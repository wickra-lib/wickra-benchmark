...
WASM boundary. See [THREAT_MODEL.md](THREAT_MODEL.md) for the asset and
...
[security advisories](https://github.com/wickra-lib/wickra-benchmark/security/advisories/new)
