...
Thanks for your interest in `wickra-benchmark`. This project values one thing above
...
cargo test -p wickra-benchmark-core --no-default-features 2>&1 | grep "test result:"
cargo deny check
```
